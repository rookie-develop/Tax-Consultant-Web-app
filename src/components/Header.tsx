    ...
    <header className="bg-slate-900 text-white border-b-4 border-emerald-500 sticky top-0 z-30 shadow-md">
      <div className="max-w-6xl mx-auto px-3.5 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-3">
        ...
        <button
          id="btn-brand-home"
          onClick={onReset}
          className="flex items-baseline space-x-1.5 sm:space-x-2 text-left group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 rounded-lg p-1 transition-all cursor-pointer select-none"
        ...
        >
          ...
          <span className="text-[9px] sm:text-xs uppercase tracking-widest text-slate-400 font-bold hidden xs:inline-block">
            Tax Compliance v1.0
          </span>
        </button>

        {/* Quick Contact & WhatsApp Action */}
        <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6 text-xs sm:text-sm font-medium">
          <button
            onClick={onReset}
          ...
          <a
            ...
            className="bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-600 text-slate-900 font-black px-3.5 py-2.5 sm:px-5 sm:py-2.5 rounded-lg flex items-center space-x-1.5 sm:space-x-2 text-[11px] sm:text-xs uppercase tracking-wider transition-transform active:scale-95 shadow-sm min-h-[44px] touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
